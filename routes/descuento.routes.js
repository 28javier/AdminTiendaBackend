...
var descuentoController = require('../controllers/descuento.controllers');
...
api.get('/listar_descuento_admin/:filtro?', [auth.auth], descuentoController.listar_descuento_admin);
